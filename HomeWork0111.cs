...
namespace ConsoleApp3
{
    internal class Program
    {
        ...
        private static void ex18()
        {
            ...
            DateTime date = new DateTime(1987, 1, 28);
            ...
            int secondthird = date.Year % 100;
            password = password.Append(secondthird);
            int chetirepyat = date.Month;
            password = password.Append(chetirepyat);
            int shestsem = date.Day;
            password = password.Append(shestsem);
            if (rnd.Next(1, 2) == 1)
            {
            ...
            char x = 'w';
            password = password.Append((int)x);
